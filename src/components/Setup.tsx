...
import { UserPlus, UserMinus, Play, Trophy } from 'lucide-react';
...
export default function Setup({ onStart }: SetupProps) {
  ...
  return (
    <div className="max-w-md w-full mx-auto bg-white rounded-3xl shadow-2xl p-10 border border-slate-100">
